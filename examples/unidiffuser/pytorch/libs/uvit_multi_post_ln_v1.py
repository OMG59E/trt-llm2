...
class UViT(nn.Module):
    ...
    def forward(self, img, clip_img, text, t_img, t_text, data_type):
        ...
        if H == self.img_size[0] and W == self.img_size[1]:
            ...
            pos_embed_patches = interpolate_pos_emb(pos_embed_patches, (self.img_size[0] // self.patch_size, self.img_size[1] // self.patch_size), (H // self.patch_size, W // self.patch_size))
