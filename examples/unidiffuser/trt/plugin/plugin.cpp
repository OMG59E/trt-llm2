...
class CustomPluginCreatorRegistry
{
public:
    static CustomPluginCreatorRegistry& getInstance()
    {
        static CustomPluginCreatorRegistry instance;
        return instance;
    }
...
public:
    CustomPluginCreatorRegistry(CustomPluginCreatorRegistry const&) = delete;
    void operator=(CustomPluginCreatorRegistry const&) = delete;
};

template <typename CreatorType>
void initializeTritonPlugin(void* logger, const char* libNamespace)
{
    CustomPluginCreatorRegistry::getInstance().addPluginCreator<CreatorType>(logger, libNamespace);
}
